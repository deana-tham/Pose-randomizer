...
A fun, slot machine-style web app that helps you figure out how to pose for photos. Pick a category, hit spin, and land on a random pose for inspiration.

**Live demo:** [pose-randomizer.vercel.app](https://pose-randomizer.vercel.app/)
...
The app tracks which poses you've already seen so you won't get repeats until you've gone through the whole set.
